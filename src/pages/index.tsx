  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Homstel - where hostel and experience booking gets a revolution with our AI-based trip-planning tool. We make your journeys unforgettable."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob3N0ZWx8ZW58MHx8fHwxNjk2NzkwNjgxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@marcusloke?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Marcus Loke`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Homstel - where hostel and experience booking gets a revolution with our AI-based trip-planning tool. We make your journeys unforgettable.`}
            </Text>
            <Box
