...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'travel-agent'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    },
    {
      ...
      path: '/experience-reviews',
      entity: 'experience_reviews',
      service: AccessServiceEnum.PROJECT,
      icon: FiStar,
    },
    { name: 'Hostels', path: '/hostels', entity: 'hostel', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Hostel Amenities',
      path: '/hostel-amenities',
    ...
    {
      name: 'Trip Itineraries',
      path: '/trip-itineraries',
